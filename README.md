...
<!-- This repository investigates a measurement-based quantum computation
(MBQC) scheme in which a GHZ state encoded in the time-bin degree of freedom of
single photons serves as a bulk resource, and two polarization qubits act as
boundary nodes. -->

This repository investigates a measurement-based quantum computation (MBQC)
protocol in which a GHZ state serves as a bulk resource, and two target qubits
